...
def my_run_fair(args, emissions, reference_year=1750):
    ...
    Cc, Fc, Tc, Tdeep, ariacic, lambda_effc, ohcc, heatfluxc = (
        my_fair_scm(  # fair.forward.fair_scm(
            emissions=emissions,
...
def fair_project_temperature(
    ...
    pooledds = xr.Dataset(
        ...
        coords={"years": proj_years, "samples": np.arange(nsamps)},
        attrs=attrs,
    )
    pooledds.to_netcdf(
