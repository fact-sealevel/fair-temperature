...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run the preprocessing stage for the FAIR AR6 temperature module",
    ...
    # Run the code
    fair_preprocess_temperature(
        scenario=args.scenario, rcmip_file=args.rcmip_file, pipeline_id=args.pipeline_id
    )
